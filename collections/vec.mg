...
// them manually. clear doesn't handle it for you.
// TODO: support function pointer so that we are able to pass destructor function
// for the vector's elements.
fn clear<T>(vec: *Vector::<T>) {
  vec.len.* = 0;
}
